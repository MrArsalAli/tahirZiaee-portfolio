        ...
        <div className="space-y-8">
          ...
          >
            ...
            <p className="font-body text-lg text-gray-300 leading-relaxed">
              ...
              throughintuitive and impactful design. As a freelancer, I
              specialize in creating seamless, user centered interfaces for
              apps, websites. Let's make your vision a reality.
            </p>
          </motion.div>
